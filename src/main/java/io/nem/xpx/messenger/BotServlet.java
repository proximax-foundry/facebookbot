...
public class BotServlet extends AbstractFacebookBotServlet {
	 ...
	 * 
	 * PRIVATE_KEY - Private key of a sender account
	 * PUBLIC_KEY - Public key of a receiver account
	 */
	public static void upload(String msg) throws UploadException {
    	...
    	final UploadTextDataParameter parameter = UploadTextDataParameter.create()
    			.senderPrivateKey(System.getenv("PRIVATE_KEY"))
    	        .receiverPublicKey(System.getenv("PUBLIC_KEY"))
    	        .data(msg)
    	        .encoding("UTF-8")
    	        .build();
